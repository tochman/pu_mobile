(function(ionic) {
  ...
  var SwipeableCardView = ionic.views.View.inherit({
    ...
    _doDrag: function(e) {
      ...
      // Hieu Pham: prevent vertical dragging
      this.el.style.transform = this.el.style.webkitTransform = 'translate3d(' + this.x + 'px, ' + '0px, 0) rotate(' + (this.rotationAngle || 0) + 'rad)';
          ...
          var swipeableCard = new SwipeableCardView({
            ...
            onSnapBack: function(startX, startY, startRotation) {
              ...
              .on('step', function(v) {
                ...
                // Hieu Pham: prevent vertical dragging
                el.style.transform = el.style.webkitTransform = 'translate3d(' + (startX - startX*v) + 'px, ' + '0px, 0) rotate(' + (startRotation - startRotation*v) + 'rad)';
